...
class TestPuzzle(unittest.TestCase):
    def test_royal_flush_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: royal-flush'))
    ...
    def test_straight_flush_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: straight-flush'))
    ...
    def test_four_of_a_kind_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: four-of-a-kind'))
    ...
    def test_full_house_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: full-house'))
    ...
    def test_flush_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: flush'))
    ...
    def test_straight_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: straight'))
    ...
    def test_three_of_a_kind_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: three-of-a-kind'))
    ...
    def test_two_pair_1(self):
        ...
        self.assertRegex(ans, re.compile('.*highest: two-pair'))
    ...
    def test_pair_1(self):
        ...
        ans = main(data)
        print("expect pair ", ans)
        self.assertRegex(ans, re.compile('.*highest: pair'))
    ...
    def test_high_card_1(self):
        ...
        ans = main(data)
        print("expect high-card ", ans)
        self.assertRegex(ans, re.compile('.*highest: high-card'))
